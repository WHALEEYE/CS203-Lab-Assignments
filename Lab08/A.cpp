...
int main() {
  ...
  while (t--) {
    ...
    cin >> n;
    int **relation = new int *[2], rear = 0, front = 0, count = 0, value,
        parent, son;
    ...
    while (count < n) {
      ...
      if ((((queue[front]->value < queue[front]->left->value &&
             queue[front]->left != nul) ||
            (queue[front]->value < queue[front]->right->value &&
             queue[front]->right != nul)) &&
           bigRoot) ||
          (((queue[front]->value > queue[front]->left->value &&
             queue[front]->left != nul) ||
            (queue[front]->value > queue[front]->right->value &&
             queue[front]->right != nul)) &&
           !bigRoot)) {
